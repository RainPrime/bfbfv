if game.PlaceId == 2753915549 then
 ...
 ImageButton.Image = "rbxassetid://102151582025543"
 
 UICorner.Parent = ImageButton	
 
 ClickSound.Parent = ImageButton
 ClickSound.SoundId = "rbxassetid://102151582025543"
 ClickSound.Volume = 1
 ...
 local Tabs = {
     Main = Window:AddTab({ Title = "General", Icon = "rbxassetid://102151582025543" }),
     ...
     TP = Window:AddTab({ Title = "Island", Icon = "rbxassetid://102151582025543" }),
     ESP = Window:AddTab({ Title = "ESP", Icon = "eye" }),   
     Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://102151582025543" }), 
     Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://102151582025543" }),
 }
 ...
 Tabs.Main:AddButton({
     ...
     game.StarterGui:SetCore("SendNotification", {
         Title = "NEXUS HUB",
         Text = "",
         Icon = "rbxassetid://102151582025543",
         Duration = 6
     })
         setclipboard("https://discord.gg/gxVeMU6dNS")
     end
